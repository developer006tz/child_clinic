            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover" id="myTable_simple">
                    <thead>
                        <tr>
                            <th class="text-left">
                                @lang('crud.insurances.inputs.provider_name')
                            </th>
                            <th class="text-left">
                                @lang('crud.insurances.inputs.insurance_name')
                            </th>
                            <th class="text-left">
                                @lang('crud.insurances.inputs.policy_number')
                            </th>
                            <th class="text-left">
                                @lang('crud.insurances.inputs.contact')
                            </th>
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="5">{!! $insurances->render() !!}</td>
                        </tr>
                    </tfoot>
                </table>
            </div>
